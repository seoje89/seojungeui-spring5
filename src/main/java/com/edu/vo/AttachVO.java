...
public class AttachVO {
	private String save_file_name; // UUID클래스(고유 해시데이터를 생성하는 클래스)로 생성예정, 실제 저장된 파일명으로 사용
	private String real_file_name; // 사용자의 눈에 보이는 파일명
	private Date reg_date; // 첨부파일 저장 일시
	private Integer bno; // 외래키(FK) - 게시물번호 
