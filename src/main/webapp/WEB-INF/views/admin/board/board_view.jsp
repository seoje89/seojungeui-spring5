    ...
    <section class="content">
      <div class="container-fluid">
        ...
        <div class="card card-primary">
          ...
          <form name="form_view" method="post" action="/admin/board/board_update_form" enctype="multipart/form-data" GET>
            <div class="card-body">
              ...
              <div class="form-group">
                ...
                <br>${boardVO.view_count}
              </div>
              <div class="form-group">
                <label for="exampleInputPassword1">작성일</label>
                <br><fmt:formatDate pattern="yyyy-MM-dd hh:mm:ss" value="${boardVO.reg_date}"/> 
              </div>
              <div class="form-group">
	                ...
	                <div class="input-group">
	                  <div class="custom-file">
	                    ...
	                    <!-- jstl에서 변수사용하기 fn:split('데이터','분할기준값') 목적: 확장자를 이용해서 이미지 미리보기 실행유무(img태그 사용여부) 결정
	                    	String[] fileNameArray = String.split('변수값','분할기준값'); 과 동일한 결과
	                     -->
	                    ...
	                    <c:choose>
	                    	...
	                    	<c:otherwise>
	                    		<!-- 아무의미 없이 개발 연습용으로 확인 -->
	                    		<c:out value="${checkImgArray}" /> 이미지가아님.
	                    	</c:otherwise>
	                    </c:choose>
	                  </div>
	                </div>
            ...
            <div class="card-body p-0">
              ...
              <div class="bs-stepper-content">
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" id="replyer" placeholder="작성자를 입력해주세요">
                </div>
                <div class="form-group">
...
$(document).ready(function() {
	...
	$('#btn_list').click(function(){
		//이곳에 있으면 함수 내 변수(var얘기)
		form_view.attr("action","/admin/board/board_list");
		form_view.attr("method","get"); //폼의 설정된 메서도 post에서 get으로 변경
		form_view.submit();
	});
