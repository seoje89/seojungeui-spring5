...
$(document).ready(function() {
	...
	<div id="container">
		...
		<div class="about_area">
			<h2><a href="/home/board/board_list?board_type=gallery&search_keyword=">갤러리 최근 게시물 <b>TOP 3</b></a></h2>
			<div class="about_box">
				<ul class="place_list box_inner clear">
					<c:forEach var="galleryVO" items="${latestGallery}">
						...
						<li><a href="/home/board/board_view?bno=${galleryVO.bno}&page=1&board_type=gallery">
								...
								<!-- jstl로 글자수 자르기 -->
									<c:choose>
										<c:when test="${fn:length(galleryVO.content) gt 51}">
