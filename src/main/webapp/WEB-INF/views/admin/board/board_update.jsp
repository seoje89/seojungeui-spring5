          ...
          <form name="form_write" method="post" action="/admin/board/board_update" enctype="multipart/form-data">
            <div class="card-body">
              ...
              <div class="form-group">
                ...
                <input value="${boardVO.title}" name="title" type="text" class="form-control" id="exampleInputEmail1" placeholder="제목을 입력해주세요" required>
              </div>
              <div class="form-group">
...
<!-- 서머노트 웹에디터 실행(개발자가 처리) -->
<script>
$(document).ready(function(){
		// $('#content_lbl').summernote(); 기본실행. 기본옵션에서 개발자가 커스터마이징 한다.
		$('')
		$('#content').summernote({
			height:150,
			lang:'ko-KR',
