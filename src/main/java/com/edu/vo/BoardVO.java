...
/**
 * 이 클래스는 게시물 CRUD에 필요한 멤버변수(필드)가 정의된 클래스
...
public class BoardVO {
	...
	//private String save_file_name; 첨부파일이 1개 이상일수 있기때문에 아래처럼 처리
	//게시물 1개 등록시 첨부파일이 1개 이상 필요. 그런데 1개의 필드에 여러개의 값을 입력할수 없음. 
	//그래서 DB에는 없는 가상 멤버변수(필드)를 2개 만듬.
