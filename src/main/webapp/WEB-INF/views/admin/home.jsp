  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      <div class="container-fluid">
          ...
          <div class="card-body p-0">
            ...
            <c:forEach var="memberVO" items="${latestMembers}">
	            <li style="cursor: pointer;" onclick="location.replace('/admin/member/member_view?user_id=${memberVO.user_id}')">
	                ...
	                <span class="users-list-date"><fmt:formatDate pattern="yyyy-MM-dd hh:mm:ss" value="${memberVO.reg_date}"/></span>
	            </li>
            </c:forEach>
        ...
        <!-- //최근 등록한 회원목록 -->
        <!-- 최근 게시물 리스트(공지사항+갤러리+QnA게시판) 현재 2개의 게시판이 나오게 됨 -->
