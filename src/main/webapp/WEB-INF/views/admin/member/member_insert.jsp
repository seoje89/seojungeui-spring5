          ...
          <form name="form_write" action="/admin/member/member_insert" method="POST" enctype="multipart/form-data">
            <div class="card-body">
              ...
              <div class="form-group">
                ...
                <input value="" name="user_id" type="text" class="form-control" id="user_id" placeholder="ID를 입력해주세요" required>
              </div>
              <div class="form-group">
                <label for="user_pw">비밀번호</label>
                <input value="" name="user_pw" type="password" class="form-control" id="user_pw" placeholder="비밀번호를 입력해주세요" required>
              </div>
              <div class="form-group">
...
<script>
$(document).ready(function() {
	//RestAPI 서버의 클래스에서 ID중복체크 메서드를 확인
	//RestAPI 클라이언트 맛보기
	$("#btn_id_check").click(function(){
		var user_id = $("#user_id").val();
		$.ajax({
			type:"get", // 입력,수정,삭제가 아니면 get방식
			url:"/id_check?user_id="+user_id, // RestAPI 서버(스프링클래스로 제작)
