          ...
          <form name="form_write" action="/admin/member/member_update" method="POST" enctype="multipart/form-data">
            <div class="card-body">
              ...
              <div class="form-group">
                ...
                <!-- 암호는 기존값이 필요없음. 이유는 값이 있으면 업데이트진행, 없으면 업데이트에서 제외됨 -->
                <input value="" name="user_pw" type="password" class="form-control" id="user_pw" placeholder="비밀번호를 입력해주세요">
              </div>
              <div class="form-group">
...
$(document).ready(function() {
	...
	$("#btn_list").click(function(){
		/* 폼을 get방식으로 전송시 암포와 같은 정보가 URL 쿼리스트링에 노출되어서 주석처리
