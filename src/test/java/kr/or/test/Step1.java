 ...
 */
public class Step1 {
	public void step1() {//클래스명과 같은 이름의 메서드를 생성자 메서드
		//자동으로 만들어진다.
		//중요한 이유는 다른 클래스에서 Step1을 객체로 만들때 생성자 메서드가 필수
		//Step1 aaa = new Step1();
		//자바앱에서는 객체를 생성자 메서드로 만들때 필수
		//스프링에서는 @Inject으로 객체를 만들어서 사용.
	}
	...
	public static void main(String[] args) {
		...
		//변수에 값을 입력(아래)
		name="홍길동";
		age=10; //자바스크립트보다 자료형 사용에 엄격하다.
		phoneNum= "000-0000-0000"; //한 문자의 끝을 명시
		...
		//메서드명이 같다. 단, 로드된 파라미터가 다른 메서드를 호출 = 오버로드
	}
	...
	private static void printMember(String name, int age, String phoneNum) {
		...
		//println 메서드는 출력 후 줄바꿈 명령실행 ln = new line 약자
	}
