...
<!-- jQuery 코어 임포트 가져오기(아래) -->
<script src="/resources/home/js/jquery-3.6.0.js"></script>
<!-- 상단 바로가기 클릭시 부드럽게 상단으로 이동하는 외부 라이브러리 js 임포트 가져오기(아래) -->
<script src="/resources/home/js/jquery.smooth-scroll.min.js"></script>
<!-- 화면을 초기화시키는 reset 스타일 임포트 : 크로스브라우징을 처리하기 위해서-->
<!-- 크롬, IE, 엣지, 사파리, 파이어폭스 등 h1, p, ul, div 태그의 크기가 조금씩 틀리다. -->
<!-- 작업한 결과가 모든 브라우저(크로싱브라우징)에 똑같이 보이게 하기 위한 절차 : reset.css(아래) -->
...
<script>
//공통으로 사용하는 변수 : 로그인성공, 마이페이지, 게시물 등록/수정/삭제 성공 메세지
if("${msg}" != "") {
