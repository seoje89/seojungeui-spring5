		...
		<div class="bodytext_area box_inner">
			...
			<form method="POST" name="board_write" action="/home/board/board_update" class="appForm" enctype="multipart/form-data">
				<fieldset>
					...
					<ul class="app_list">
		                ...
		                $(document).ready(function(){		                	
		                	$(".btn_file_delete").click(function(){
		                		...
		                		if(delete_file_name == ""){ // != 로 테스트, 확인후 ==로 변경
		                			alert("선택한 파일이 없습니다.");
		                			return true; 
		                		} //아래 내용이 진행안되고 종료됨              		
		                		$.ajax({
		                			url:"/file_delete?save_file_name="+delete_file_name, //컨트롤러 구현
		                			type:"post",
					...
					<p class="btn_line">
					<button class="btn_baseColor">수정</button>
